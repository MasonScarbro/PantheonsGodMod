...
namespace GodsAndPantheons
{
    ...
    {
        public string settingVersion = "0.2.2";
        ...
        public Dictionary<string, Dictionary<string, InputOption>> Chances = new Dictionary<string, Dictionary<string, InputOption>>
        {
            ...
            {"GodOfFireWindow",
                new Dictionary<string, InputOption>
              {
                 ...
                 {"ChaosLaser%", new InputOption(true, 2, "[ITEM] allows the holder of the staff of fire to cast a super-deadly laser to annihilate the enemy")},
                 {"God Of Fireinherit%", new InputOption(true, 44, "the chance of a child of a god of fire to inherit a stat / ability / trait")}
              }
            },
            {"MoonGodWindow",
                new Dictionary<string, InputOption>
              {
                 ...
                 {"God Of the Starsinherit%", new InputOption(true, 30, "the chance of a child of a god of stars to inherit a stat / ability / trait")}
              }
            },
            {"DarkGodWindow",
                new Dictionary<string, InputOption>
              {
                  ...
                  {"GodOfTheShadows%", new InputOption(true, 8, "[SPECIAL] turns the god of dark invisible")},
                  ...
                  {"God Of the Nightinherit%", new InputOption(true, 40, "the chance of a child of a god of night to inherit a stat / ability / trait")}
              }
            },
            {"SunGodWindow",
                new Dictionary<string, InputOption>
              {
                  ...
                  {"lightBallz%", new InputOption(true, 8, "shoots balls of light at the enemy")},
                  {"AtTheSpeedOfLight%", new InputOption(true, 10, "[SPECIAL] the god of light can move at such high speeds that anything he touches is annihilated....") },
                  {"LightOrbs%", new InputOption(true, 5, "[ITEM] creates light orbs")},
                  {"SunGodsSlashes%", new InputOption(true, 20, "Creates Light Slashes") },
                  {"God Of lightinherit%", new InputOption(true, 42, "the chance of a child of a god of sun to inherit a stat / ability / trait")}
              }
            },
            ...
            {"WarGodWindow",
                new Dictionary<string, InputOption>
              {
                  ...
                  {"God Of Warinherit%", new InputOption(true, 35, "the chance of a child of a god of war to inherit a stat / ability / trait")}
              }
            },
            {"EarthGodWindow",
                new Dictionary<string, InputOption>
              {
                  ...
                  {"God Of the Earthinherit%", new InputOption(true, 26, "the chance of a child of a earth god to inherit a stat / ability / trait")}
              }
            },
            {"ChaosGodWindow",
                new Dictionary<string, InputOption>
              {
                  ...
                  {"God Of Chaosinherit%", new InputOption(true, 36, "the chance of a child of a god of chaos to inherit a stat / ability / trait")}
              }
            },
            {"LoveGodWindow",
                new Dictionary<string, InputOption>
