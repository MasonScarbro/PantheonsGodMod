...
namespace GodsAndPantheons
{
    class Effects
    {
        public static void init()
        {
            ...
            sunGodEra.base_stats.set("armor", 13);
            sunGodEra.base_stats.set("health", 500);
            sunGodEra.base_stats.set("speed", 300);
            sunGodEra.base_stats.set("mass", 0.5f);
            sunGodEra.base_stats.set("knockback", 1f);
            sunGodEra.base_stats.set("attack_speed", 80f);
            ...
            darkGodEra.base_stats.set("armor", 25f);
            darkGodEra.base_stats.set("health", 500);
            darkGodEra.base_stats.set("speed", 30);
            darkGodEra.base_stats.set("mass", 0.6f);
            darkGodEra.base_stats.set("knockback", 2f);
            darkGodEra.base_stats.set("attack_speed", 8f);
            ...
            FireGodEra.base_stats.set("armor", 8);
            FireGodEra.base_stats.set("multiplier_health", 0.55f);
            FireGodEra.base_stats.set("speed", 70);
            FireGodEra.base_stats.set("mass", 0.5f);
            FireGodEra.base_stats.set("multiplier_crit", 0.5f);
            FireGodEra.base_stats.set("attack_speed", 40f);
            FireGodEra.base_stats.set("scale", 0.075f);
            ...
            knowledgeGodEra.base_stats.set("armor", 15);
            knowledgeGodEra.base_stats.set("health", 500);
            knowledgeGodEra.base_stats.set("speed", 20);
            knowledgeGodEra.base_stats.set("mass", 0.9f);
            knowledgeGodEra.base_stats.set("knockback", 1f);
            knowledgeGodEra.base_stats.set("attack_speed", 20f);
            knowledgeGodEra.base_stats.set("intelligence", 200f);
            knowledgeGodEra.base_stats.set("stewardship", 20f);
            knowledgeGodEra.base_stats.set("range", 40f);
            knowledgeGodEra.base_stats.set("accuracy", 20f);
            ...
            LoveGodEra.base_stats.set("armor", 8);
            LoveGodEra.base_stats.set("health", 500);
            LoveGodEra.base_stats.set("speed", 20);
            LoveGodEra.base_stats.set("mass", 0.9f);
            LoveGodEra.base_stats.set("knockback", 1f);
            LoveGodEra.base_stats.set("attack_speed", 20f);
            LoveGodEra.base_stats.set("stewardship", 20f);
            LoveGodEra.base_stats.set("range", 10f);
            LoveGodEra.base_stats.set("accuracy", 5);
            ...
            starsGodEra.base_stats.set("health", 500);
            starsGodEra.base_stats.set("multiplier_health", 0.5f);
            starsGodEra.base_stats.set("speed", 30);
            starsGodEra.base_stats.set("mass", 0.8f);
            starsGodEra.base_stats.set("armor", 10);
            starsGodEra.base_stats.set("attack_speed", 80f);
            ...
            EarthGodEra.base_stats.set("multiplier_health", 0.8f);
            EarthGodEra.base_stats.set("multiplier_speed", 0.25f);
            EarthGodEra.base_stats.set("mass", 0.8f);
            EarthGodEra.base_stats.set("multiplier_damage", 0.3f);
            EarthGodEra.base_stats.set("armor", 15);
            EarthGodEra.base_stats.set("attack_speed", 80f);
            ...
            warGodEra.base_stats.set("armor", 25);
            warGodEra.base_stats.set("health", 500);
            warGodEra.base_stats.set("speed", 30);
            warGodEra.base_stats.set("mass", 0.2f);
            warGodEra.base_stats.set("knockback", 2f);
            warGodEra.base_stats.set("attack_speed", 8f);
            warGodEra.base_stats.set("damage", 30f);
            ...
            lichgodera.base_stats.set("armor", 25);
            lichgodera.base_stats.set("health", 500);
            lichgodera.base_stats.set("speed", 30);
            lichgodera.base_stats.set("mass", 0.2f);
            lichgodera.base_stats.set("knockback", 2f);
            lichgodera.base_stats.set("attack_speed", 8f);
            lichgodera.base_stats.set("multiplier_damage", 0.3f);
            ...
            Invisible.base_stats.set("speed", 60);
            Invisible.base_stats["mass"] -= 5;
            ...
            Lassering.base_stats.set("multiplier_speed", -0.75f);
            ...
            chaosgodsera.base_stats.set("armor", 25);
            chaosgodsera.base_stats.set("health", 500);
            chaosgodsera.base_stats.set("speed", 30);
            chaosgodsera.base_stats.set("mass", 0.2f);
            chaosgodsera.base_stats.set("knockback", 2f);
            chaosgodsera.base_stats.set("attack_speed", 8f);
            chaosgodsera.base_stats.set("damage", 30f);
            chaosgodsera.base_stats.set("armor", 10f);
            chaosgodsera.base_stats.set("multiplier_health", 0.3f);
            ...
            warGodsCry.base_stats.set("armor", 25);
            warGodsCry.base_stats.set("multiplier_health", 0.20f);
            warGodsCry.base_stats.set("speed", 20);
            warGodsCry.base_stats.set("mass", 0.8f);
            warGodsCry.base_stats.set("knockback", 2f);
            warGodsCry.base_stats.set("multiplier_attack_speed", 0.5f);
            warGodsCry.base_stats.set("damage", 15f);
            ...
            ICANTSEE.base_stats["range"] -= 10000;
            ICANTSEE.base_stats.set("critical_chance", -1);
            ICANTSEE.base_stats["speed"] -= 15;
            ICANTSEE.base_stats["mass"] -= 0.6f;
            ICANTSEE.base_stats["damage"] -= 30f;
            ...
            Petrified.base_stats["range"] -= 10000;
            Petrified.base_stats["speed"] -= 10000;
            Petrified.base_stats.set("mass", 99999);
            Petrified.base_stats["damage"] -= 99999;
            ...
            BrainWashed.base_stats.set("speed", 3);
            BrainWashed.base_stats["mass"] -= 0.6f;
            BrainWashed.base_stats.set("attack_speed", 3);
            BrainWashed.base_stats.set("damage", 5f);
            ...
            AtTheSpeedOfLight.base_stats.set("armor", 30);
            AtTheSpeedOfLight.base_stats.set("speed", 500);
            AtTheSpeedOfLight.base_stats.set("multiplier_speed", 1);
