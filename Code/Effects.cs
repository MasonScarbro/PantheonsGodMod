...
namespace GodsAndPantheons
{
    ...
    { 
        public static void init()
        {
            ...
            sunGodEra.base_stats[S.knockback] += 15f;
            ...
            darkGodEra.base_stats[S.knockback_reduction] += 100f;
            darkGodEra.base_stats[S.knockback] += 50f;
            ...
            knowledgeGodEra.base_stats[S.knockback] += 5f;
            ...
            starsGodEra.base_stats[S.knockback] += 10f;
