...
namespace GodsAndPantheons
{
    class Units
    {
        ...
        public static void loadAssets()
        {
            ...
            godHunter.base_stats.set("lifespan", 1000f);
            godHunter.base_stats.set("health", 100f);
            godHunter.base_stats.set("damage", 35f);
            godHunter.base_stats.set("speed", 65f);
            godHunter.base_stats.set("attack_speed", 55f);
            godHunter.base_stats.set("mass", 10f);
            godHunter.base_stats.set("critical_chance", 1f);
            godHunter.base_stats.set("knockback", 0.1f);
            godHunter.base_stats.set("accuracy", 8f);
            godHunter.base_stats.set("range", 1f);
            godHunter.base_stats.set("targets", 1f);
            ...
            darkOne.base_stats.set("lifespan", 1f);
            darkOne.base_stats.set("health", 100);
            darkOne.base_stats.set("damage", 25f);
            darkOne.base_stats.set("speed", 35f);
            darkOne.base_stats.set("mass", 20f);
            darkOne.base_stats.set("attack_speed", 50f);
            darkOne.base_stats.set("critical_chance", 0.1f);
            darkOne.base_stats.set("knockback", 0.1f);
            darkOne.base_stats.set("accuracy", 8f);
            darkOne.base_stats.set("range", 1f);
            darkOne.base_stats.set("targets", 1f);
